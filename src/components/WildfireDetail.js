...
const WildfireDetail = (detailInfo) => {
  // Retrieve data about current wildfire
      ...
      <MuiThemeProvider theme={createTheme(theme)}>
        <div className="rightContainer">
          <div onClick={detailInfo.close}>
            <Player // The icon for user to close the details panel
              ...
              <CardContent>
                ...
                >
                  ...
                  <div style={{ display: "flex", flexDirection: "column" }}>
                    ...
                    />
                    <Avatar // Link to resources icon
                      key={"show-more"}
                      src={"https://img.icons8.com/bubbles/344/quote-left.png"}
                      onClick={() =>
                        window.open(data ? data.info.link : "/", "_blank")
                      }
                    />
                  </div>
                </div>
